...
class RankingAgent:
    ...
    """
    def __init__(self, input_dim=384, learning_rate=0.001, pretrained_model=None, train_size=10):
        """
        :param input_dim: feature size of embeddings, default 384 for SBERT
        :param learning_rate: learning rate of the optimizer, default 0.001 based on hyperparameter tuning
